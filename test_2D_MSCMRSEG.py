...
parser.add_argument('--root_path', type=str, default='/workspace/dataset/MSCMRSEG/mscmrseg_split2', help='Name of Experiment')
parser.add_argument('--model', type=str, default='unet', help='model_name')
parser.add_argument('--num_classes', type=int, default=4, help='output channel of network')
parser.add_argument('--labeled_num', type=int, default=3, help='labeled data')
parser.add_argument('--ckpt', type=str,
                    default='/workspace/DiffRect-main/logs/353 clean student labeled cutmix MSCMRSEG_mscmrseg_split2_7_labeled/unet/unet_best_model_iter_num43100_0.8802810289553009.pth',
...
def Inference(FLAGS, split_name=None):
    ...
    test_save_path = os.path.join(base_dir, 'predictions0818', split_name)

...
parser.add_argument("--labeled_num", type=int, default=2, help="labeled patients (PROSTATE 10%% protocol)")
...
parser.add_argument("--phys_blend", type=float, default=0.02, help="Residual blend ratio for physics output; smaller means closer to baseline")
...
def patients_to_slices(dataset, patiens_num):
    ...
    elif "PROSTATE" in dataset or "prostate" in dataset.lower():
        assert args.num_classes == 3, "PROSTATE only has 3 classes"
